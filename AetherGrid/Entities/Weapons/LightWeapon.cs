...
{
    // Constructor includes posX and posY
    public LightWeapon(string name, string description, int posX, int posY, Dictionary<ItemProperty, int> itemProperties, Dictionary<StatType, int> statModifiers)
